    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) {
          showToast('Bu sipariş için henüz fatura oluşturulmamış.', 'error')
          return
        }
